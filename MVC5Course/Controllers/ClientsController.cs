...
namespace MVC5Course.Controllers
{
    public class ClientsController : Controller
    {
        ...
        ClientRepository cRepo = RepositoryHelper.GetClientRepository();
        OccupationRepository oRepo = RepositoryHelper.GetOccupationRepository();
        ...
        public ActionResult Details(int? id)
        {
            ...
            var client = cRepo.Find(id.Value);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.OccupationId = new SelectList(oRepo.All(), "OccupationId", "OccupationName");
        ...
        public ActionResult Create([Bind(Include = "ClientId,FirstName,MiddleName,LastName,Gender,DateOfBirth,CreditRating,XCode,OccupationId,TelephoneNumber,Street1,Street2,City,ZipCode,Longitude,Latitude,Notes")] Client client)
        {
            if (ModelState.IsValid)
            {
                ...
                //db.SaveChanges();
                cRepo.Add(client);
                cRepo.UnitOfWork.Commit();

                return RedirectToAction("Index");
            }

            //ViewBag.OccupationId = new SelectList(db.Occupation, "OccupationId", "OccupationName", client.OccupationId);
            ViewBag.OccupationId = new SelectList(oRepo.All(), "OccupationId", "OccupationName", client.OccupationId);
            return View(client);
        }
        ...
        public ActionResult Edit([Bind(Include = "ClientId,FirstName,MiddleName,LastName,Gender,DateOfBirth,CreditRating,XCode,OccupationId,TelephoneNumber,Street1,Street2,City,ZipCode,Longitude,Latitude,Notes")] Client client)
        {
            if (ModelState.IsValid)
            {
                ...
                //db.SaveChanges();
                cRepo.UnitOfWork.Context.Entry(client).State = EntityState.Modified;
                cRepo.UnitOfWork.Commit();
        ...
        public ActionResult Delete(int? id)
        {
            ...
            //Client client = db.Client.Find(id);
            Client client = cRepo.Find(id.Value);
            if (client == null)
            {
                return HttpNotFound();
            }
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                cRepo.UnitOfWork.Context.Dispose();
            }
